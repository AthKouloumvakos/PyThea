...
sliders_GCS = {
                ...
                'alpha': {'Standard': {'min': 0., 'max': 90., 'step': 0.1, 'def': 45.},
                            ...
                            'unit': '[deg.]' },
                'kappa': {'Standard': {'min': 0., 'max': 1., 'step': 0.05, 'def': 0.3},
